...
const initialView =
  queryParams.get("view") === "screen" ? "screen" : routePath === "/communication" ? "radar" : routePath === "/arena" ? "arena" : "timeline";
...
function applyView() {
  ...
  els.toolbar.hidden = isScreen || isRadar || isArena;
  els.summaryStrip.hidden = isScreen || isRadar || isArena;
  els.timelineList.hidden = isScreen || isRadar || isArena;
  els.screenBoard.hidden = !isScreen;
  els.radarBoard.hidden = !isRadar;
  els.arenaBoard.hidden = !isArena;
  els.sourceTabs.hidden = isScreen || isRadar || isArena || state.feed !== "all";
